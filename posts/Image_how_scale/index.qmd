...
## How to… Scale
Every scientific image needs scale information to allow audiences to compare and relate the image size with the physical world [alas, not enoug published images have scales](../Image_numbers/index.qmd). Scale information is best conveyed with a scale bar with its physical dimensions. It’s also possible to make statements about the size of the entire image, or, as last resort, state the dimensions in the figure legend.
...
## Scales by size comparisons - some good, some meh
