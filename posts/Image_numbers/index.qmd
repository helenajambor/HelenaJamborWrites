...
![Many, many papers omit scale information in images](Scale_numbers.png){}
![Examples of poor and better scale information for images](Scale_examples.png){}
...
![Colors in microscope images and visibility tests](Colors.png){}

![Examples of color visibility](Colors_visibility.png)
...
![Inset example and the number of missing inset explanations](Insets_numbers.png){}
...
![Poor and better annotations, here of the color channels](Annotations.png){}
...
I have compiled a string blog posts “How to… Publish Images” that provide a rapid guidance and links to further resources. 
