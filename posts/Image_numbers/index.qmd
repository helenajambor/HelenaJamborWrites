...
Scale information can come in many forms and all of them were acceptable to us: as scale bar inside the image, as information about the physical size of the entire image in figures, and even an indication of the magnification were deemed acceptable. This however was entirely missing in 10-30% of the papers and incomplete in another 30-40% (Jambor et al., 2021). 

![Many, many papers omit scale information in images <a href ="https://journals.plos.org/plosbiology/article?id=10.1371/journal.pbio.3001161">from Jambor et al., 2021</a>)](Scale_numbers.png){}
![Examples of poor and better scale information for images <a href ="https://journals.plos.org/plosbiology/article?id=10.1371/journal.pbio.3001161">from Jambor et al., 2021</a>)](Scale_examples.png){}
...
<ul>
<li>How to... image formatting (August 1)</li>
