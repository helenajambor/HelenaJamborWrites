...
categories:
  ...
  - how-to
#  - history
image: "Annotations_toomany2.png"
---
## How to… image annotation
I already spoke why we need to annotate more, how to choose your image format, and annotate physical scales. But we also have to annotate symbols, regions, stainings and fluorphores (for general colors wait for next post). 
